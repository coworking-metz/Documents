...
> Les membres sont invités à participer activement à la vie, l'entretien, et le développement de l'espace, et en respectant le lieu et les autres membres.

> **3 Accessibilité et Tarification**
> L'association milite pour un accès abordable à son espace de coworking, en proposant différents tarifs, y compris des tarifs réduits pour les étudiants et les chercheurs d'emploi.

> **4 Règles d'Adhésion et d'Accès**
> L'accès à l'espace nécessite une adhésion valide et le respect du règlement intérieur.

> **5 Discrétion**
> Le coworking requiert un comportement respectueux et discret. Les discussions à voix haute et les téléphones en mode sonnerie sont proscrits dans les zones de travail ouvertes.
...
> **7 Règles de Sécurité et d'Exclusion**
...
> **8 Accueil des Visiteurs et Usage des Espaces Partagés**
...
_Le Conseil d'Administration de l’Association Coworking Metz_
...
L’association se réserve également le droit de refuser l’accès à toute personne dont la nature de l’activité ne serait pas ou plus compatible avec le fonctionnement global de l’espace. Il en est de même pour les activités ne répondant pas au projet associatif de l’association.

Un remboursement serait alors effectué au prorata de la consommation (hors adhésion et carte d’accès).
...
- Accès à l’espace :  
  - 10 tickets : 80 € ou 60 € en tarif réduit
  - temps plein : 80 € / mois ou 60 € / mois en tarif réduit
...
Les achats sont **nominatifs**, **non cessibles** et **non remboursables**. L’accès à l’espace est conditionné par un solde positif de tickets ou un abonnement au mois en cours de validité ainsi qu’à la possession d’une adhésion à l’association en cours de validité.

Les tickets sont débités à la demie journée. Par exemple : deux heures de présences sur un après-midi compte pour un demi ticket. Ce calcul est géré informatiquement et de manière automatique.

### Utilisation de l’espace et des services associés

- **Entretiens du lieu**

Le ménage et le rangement du coworking sont à la charge des membres de l'assocation. Les membres doivent donc faire attention à ne pas salir, et à nettoyer et ranger systématiquement en cas de besoin. Un ménage collectif est organisé un mardi sur deux, à 13h30. 

Tous les équipements sont disponibles en cas de besoin : balai, pelle & balayette, aspirateur, éponge, serpillière, seau, produits d’entretien, etc.
...
Les postes de travail n’étant pas privatifs, le coworker ne peut, en aucun cas, stocker dans l’espace ses effets personnels et/ou son matériel professionnel. A chaque fin de poste, la chaise doit être rangée sous le bureau. 
...
Des rangements sont mis à disposition des coworkers pour leur permettre de désencombrer l’espace de travail durant la journée. Ils n’ont pas pour vocation de servir de stockage à long terme, et seulement pour du petit matériel (clavier, souris, etc.).
...
Dans le cas de la nécessité d’usage plus intensif, une participation sera alors demandée au coworker qui en exprimerait le besoin, et ce de manière à couvrir les consommables utilisés.

Dans tous les cas, l’usage de l’imprimante se fera de manière **raisonnée** en évitant tout **gaspillage**.

- **Ouverture**

Le premier coworker arrivant le matin est invité à allumer les lumières et aérer quelques minutes l’espace de coworking en ouvrant les fenêtres.

- **Fermeture**

Le dernier coworker doit vérifier la fermeture des fenêtres, éteindre les lumières et s’assurer que les portes soient fermées à clé.

- **Adresse de BLIIIDA**

Il est interdit d’utiliser l’adresse postale du Coworking ou de BLIIIDA sur un support de communication (par exemple sur son site internet), à moins de disposer d’un contrat de domiciliation commerciale à BLIIIDA.

- **Démarchage, prospection ou publicité**

L’espace de coworking n’est pas un lieu de démarchage ou prospection commerciale.

Il n’est pas possible de faire sa publicité au travers de supports de communication (flyers, cartes de visite, etc.) qui seraient déposés dans l’espace. 
...
L’espace de coworking n’a pas vocation à accueillir dans son espace des structures constituées de plusieurs personnes. Le travail de groupe doît se faire de manière ponctuelle et uniquement dans l’espace collaboratif. 

- **Discussions**

Les discussions sont à proscrire dans l’open space. Le coworker s’engage à rester le plus discret possible dans l’open space.

- **Téléphone**

Les téléphones doivent impérativement fonctionner en mode silencieux.

Les appels téléphoniques sont à passer à l’extérieur de l’open space : les phone box, la salle collaborative, la racine, la terrasse… sont prévus à cet effet.
...
Pour conserver un état de propreté maximal de l’espace de coworking, **toute nourriture est interdite (sandwiches, chips, barres chocolatées, confiserie, fruits, gâteaux et plus généralement tout ce qui pourrait être commestible)** dans l’ensemble de l’espace de coworking. Des exceptions sont tolérées dans l'espace détente de manière ponctuelle en cas d'anniversaire, goûter, etc. sous réserve que le lieu reste propre.

La consommation de boisson est acceptée à condition de laisser les installations propres. La consommation d’alcool est interdite en dehors des manifestations et animations organisées par l’association.

Il est possible à tous les membres de l’association d’utiliser le réfrigérateur du Coworking pour du stockage de courte durée. Du tri dans le frigo est fait régulièrement, sans préavis.
...
Pour tout besoin exceptionnel d’accueil d’une personne extérieure à l’association (invité, amis, client, collaborateur, etc.), vous devrez vous rapprocher d’un membre du Conseil d’Administration (C.A.) ou en faire la demande par voie électronique, et ce à minima 72h avant la date souhaitée.

Le C.A. se réserve le droit d’accepter ou de refuser toute demande.

**Une présentation spontanée d’un public extérieur sans demande préalable se verra systématiquement refusée.**

Des salles de réunion sont disponibles à la location et à tarif préférentiel par BLIIIDA.
...
L’espace collaboratif est un lien d'usage poncutel pour vos visios et appels. Cet espace est mutualisé et donc accessible à l’ensemble des coworkers.

De manière générale, il n’est pas possible de travailler seul sur un bureau dans cet espace, sauf en cas de forte affluence et avec l'accord du Conseil d’Administration.
...
L’espace détente n’est pas un espace de travail. Les appels, visios, ou réunions/discussions de travail y sont interdites.

De façon générale, le niveau sonore restera maitrisé afin de ne pas déranger l’open-space.
